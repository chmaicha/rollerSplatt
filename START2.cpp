...
auto playItem =MenuItemImage::create("/Users/mac_hd/Desktop/namegame/Resources/images/MENU.PLAY.png",
                                     "/Users/mac_hd/Desktop/namegame/Resources/images/MENU.PLAY.png",
                                       CC_CALLBACK_1(level2::GoToGameOverScene, this));//The number 1 at the end of CC_CALLBACK_1 specifies how many parameters the function that is being called takes
...
auto backgroundSprite = Sprite::create("/Users/mac_hd/Desktop/namegame/Resources/images/leveel1-2.png");
...
//the function "GoToGameScen" creates a local scene instance  and replace it with niveau2
void level2::GoToGameOverScene(cocos2d::Ref *pSender)
{
